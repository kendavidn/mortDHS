#' @title Rwanda DHS Individual Recode Files from Four Surveys
#'
#' @description Contains data from 23,918 respondents from the Rwanda 2004 through 2014 DHS surveys.
#'
